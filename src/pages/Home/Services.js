  ...
  return (
    <div className=''>
        <div className='text-center pt-[7rem]'>
            ...
            <h1 className='text-4xl text-slate-400'>Our 3-Step Process</h1>
            <div className='grid grid-cols-3 text-center pt-10 divide-x-2 divide-amber-300 divide-dashed'>
        ...
        <div className='pt-40 grid grid-cols-2 gap-10'>
            <img src="raize-white.png" alt='toyota gr' />
            <div>
                <h3 className='text-md text-amber-300 font-medium'>BEST SERVICES</h3>
                <h1 className='text-4xl text-slate-400'>Get the best experience<br /> with our rental deals</h1>
